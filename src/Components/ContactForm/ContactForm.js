      ...
      <div class="card">
        ...
        <form class="card-form" onSubmit={handleSubmit}>
          ...
          <div class="row">
            <div class="col-xs-5 col-sm-5">
              <div class="countryCodeInput">
                ...
                <label htmlFor="CountryCode" class="input-label">
                  +
                </label>
              </div>
            </div>
            <div class="col-xs-7 col-sm-7">
              <div class="countryCodeInput">
                <input
                  ...
                  required
                />
                <label htmlFor="phoneno" class="input-label">
                  Phonen no.
                </label>
              </div>
            </div>
          ...
          <div class="input">
            ...
            <label htmlFor="counselMode" class="input-label">
              Counselling Mode:
            </label>
          </div>
          ...
          <div class="input">
            ...
            <label htmlFor="Studylevel" class="input-label">
              Study Level:
            </label>
          </div>
          ...
          <div class="input">
            ...
            <label htmlFor="country" class="input-label">
              Country:
            </label>
          </div>
          ...
          <div class="card-info">
            <input
              ...
              required
            />
            <label class="checkboxinfo" htmlfor="terms">
