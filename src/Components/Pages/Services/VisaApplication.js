                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      <p className="Visa-listPara">
                        Once student admission is done the next step is visa
                        processing. Different countries have different
                        requirements. We guide you to fill up the visa
                        application form as per requirement and get your
