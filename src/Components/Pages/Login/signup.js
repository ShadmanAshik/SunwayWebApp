    ...
    <div className="form-container-signup">
      <div className="form-content-signup">
        <form className="form-signup" onSubmit={handleSubmit}>
          <h1>
            Fill out the login information to Signup. Have an account?{" "}
            <Link to="/Login">
              Sign in
            </Link>
          </h1>
        ...
        <div className="form-inputs-signup">
          <label htmlFor="country" className="form-label-signup">
            Country
          </label>
          <select
            id="country"
          ...
          <div className="form-inputs-signup">
            <label htmlFor="confirmPassword" className="form-label-signup">
               Confirm Password:
            </label>
            <input
              id="confirmPassword"
          ...
          <div className="form-inputs-signup">
          <label htmlFor="phoneno" className="form-label-signup">
            Phone No.
          </label>
          <input
            id="phoneno"
          ...
          <button className="form-input-apply-signup" type="submit">
            Sign up
          </button>
        </form>
      </div>
