    ...
    <div className="container" id="Agent-formContiner">
      <div className="Agent-form">
        <form className="Agent-card-form">
          ...
          <p className="note">*Type/Select "N/A" for Non-Applicable fields.</p>
          <div className="row">
          ...
          <div className="row">
            <div className="Agent-input col-5">
              <select
                id="BcountryCode"
                type="text"
                name="BcountryCode"
                className="Agent-input-field"
                value={BcountryCode}
                onChange={(e) => setBcountryCode(e.target.value)}
                required
              >
                <option value=""></option>
                <option value="N/A">
              ...
              <label
                htmlFor="BcountryCode"
                className="Agent-input-labelrowAgent"
              >
                Country Code:
              </label>
            </div>

            <div className="Agent-input col-7">
              <input
                id="Bphone"
                type="tel"
                name="Bphone"
                ...
                required
              />
              <label htmlFor="Bphone" className="Agent-input-label">
                Business Number
              </label>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="Agent-input col-7">
              <input
                ...
                required
              />
              <label htmlFor="phoneno" className="Agent-input-label">
                Phone no.
              </label>
            </div>
          </div>
          ...
          <hr class="solid" />
          <p className="divider">
            For All Applicants<i class="arrow uil uil-arrow-down-right"></i>
          </p>
          ...
          <div className="row">
            ...
            <div className="Agent-input col-7">
              <input
                ...
                required
              />
              <label htmlFor="WAphone" className="Agent-input-label">
                Whatsapp Number
              </label>
            </div>
          </div>
          ...
          <div className="Agent-input">
            ...
            <label htmlFor="BcountryCode" className="Agent-input-label">
          ...
          <div className="Agent-input">
            ...
            <label htmlFor="agentphoto" className="Agent-input-label-file">
              Agent Photo<i class="arrow uil uil-arrow-down-right"/>
            </label>
          </div>
          ...
          <div className="Agent-input">
            ...
            <label htmlFor="agentnid" className="Agent-input-label-file">
              Agent Scanned NID<i class="arrow uil uil-arrow-down-right"/>
            </label>
          </div>
          ...
          <div className="Agent-input">
            ...
            <label htmlFor="passport" className="Agent-input-label-file">
              Scanned Passport<i class="arrow uil uil-arrow-down-right"/>
            </label>
          </div>
          ...
          <div className="Agent-input">
            ...
            <label htmlFor="tradelicense" className="Agent-input-label-file">
              Scanned Trade License<i class="arrow uil uil-arrow-down-right"/>
            </label>
          </div>
          ...
          <div className="Agent-input">
            <input
              ...
              className="Agent-input-field-file"
              value={busninessReg}
              onChange={(e) => setbusninessReg(e.target.value)}
            />
            <label htmlFor="busninessReg" className="Agent-input-label-file">
              Scanned Business Registration<i class="arrow uil uil-arrow-down-right"/>
            </label>
          </div>
          ...
          <div className="Agent-input">
            ...
            <label htmlFor="tinbin" className="Agent-input-label-file">
              Scanned TIN / BIN<i class="arrow uil uil-arrow-down-right"/>
            </label>
          </div>
