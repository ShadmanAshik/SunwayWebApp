    ...
    <div className="container" id="Agent-formContiner">
      <div className="Agent-form">
        <form className="Agent-card-form">
          ...
          <span className="businessfields" style={agentType === "buninessagent" ? {display:"block"} : {display:"none"}} >
            <br />
            <hr class="solid" />
            <p className="divider">
          ...
          <div className="agentfield" style={agentType === "individualagent" ? {display:"block"} : {display:"none"}}>
            <br />
            <hr class="solid" />
            <p className="divider">
